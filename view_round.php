<?php
    ...
    for ($j=1; $j <= $raceCount; $j++) { 
        $roundCourses[$j] = $_POST['courses'][$j];
    }
    ...
    for ($i=1; $i <= $playerCount; $i++) {
        ...
        $player->name = $_POST['names'][$i];
        $player->character = $_POST['characters'][$i];
        $player->vehicle = $_POST['vehicles'][$i];
        $player->transmission = $_POST['transmissions'][$i];

        for ($j=1; $j <= $raceCount; $j++) { 
            $place = $_POST['places'][$i][$j];
